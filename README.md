...
2. **Buscar libros registrados**: Muestra todos los libros que han sido registrados en la base de datos.
3. **Buscar  autores registrados**: Muestra todos los autores que han sido registrados en la base de datos.
